...
urlpatterns = [
    ...
    path('yorkies/<int:yorkie_id>/add_feeding/', views.add_feeding, name='add_feeding'),
    path('yorkies/<int:yorkie_id>/assoc_toy/<int:toy_id>/', views.assoc_toy, name='assoc_toy'),
    path('yorkies/<int:yorkie_id>/unassoc_toy/<int:toy_id>/', views.unassoc_toy, name='unassoc_toy'),
